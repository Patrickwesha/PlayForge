...
/** Five offensive linemen on the LOS, 1 yd apart. Blank by default (center is a blank square); labels are opt-in. */
export function ol(labels: OlLabels = 'none', spacing = 1): PlayerSpec[] {
  ...
  return [
    ...
    { label: labels === 'none' ? '' : 'C', x: 0, y: 0, symbol: 'square', role: 'C' },
